...
class ExhibitionModel {
    ...
    public function update($id, $data, $gallery_id) {
        ...
        $params = [
            ':id' => $id,
            ':gallery_id' => $gallery_id // gallery_id는 항상 필요
        ];
        ...
        $setParts[] = "gallery_id = :gallery_id"; // (보안 상 WHERE 절에도 포함하는 것이 좋습니다)

        $sql = "UPDATE APIServer_exhibition SET " . implode(', ', $setParts) . " WHERE id = :id";
